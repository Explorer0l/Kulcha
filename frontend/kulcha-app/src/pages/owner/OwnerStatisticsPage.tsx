    ...
    const fetchData = async () => {
      ...
      if (storedUser && isAuthenticated === 'true' && userRole === 'admin') {
        try {
          ...
          const restaurant = getRestaurantData(parsedUser.restaurantId);
          ...
          const orders = getRestaurantOrders(parsedUser.restaurantId);
          ...
          const totalRevenue = restaurant ? restaurant.totalRevenue : 0;
          console.log('Total revenue:', totalRevenue);
          setRestaurantRevenue(totalRevenue);
          
          // Получаем количество заказов
          const orderCount = restaurant ? restaurant.totalOrders : 0;
    ...
    if (storedUser) {
      try {
        ...
        if (restaurant) {
          ...
          setRestaurantData(restaurant);
          setRestaurantRevenue(restaurant.totalRevenue);
          setOrderCount(restaurant.totalOrders);
        }
